...
#
# COMMAND:
#   pypi2nix -V 3.7 -e beautifulsoup4 -e boto -e awscli -E python37Packages.setuptools -E python37Packages.setuptools_scm -E python37Packages.setuptools-git -E python37Packages.vcversioner
#
...
let
  ...
  generated = self: {
    ...
    "awscli" = python.mkDerivation {
      name = "awscli-1.16.147";
      src = pkgs.fetchurl {
        url = "https://files.pythonhosted.org/packages/9f/d0/946eed7268239ef71e90aa6221331333b69582d3c99737d99c89066fd361/awscli-1.16.147.tar.gz";
        sha256 = "3c53a97d817798287e5468d5dd57acc3b9a8b02f495a32f80582f6b323294c20";
      };
      doCheck = commonDoCheck;
      checkInputs = commonBuildInputs ++ [ ];
      buildInputs = commonBuildInputs ++ [ ];
    ...
    "botocore" = python.mkDerivation {
      name = "botocore-1.12.137";
      src = pkgs.fetchurl {
        url = "https://files.pythonhosted.org/packages/ec/79/5f739631371a26fe0393ac77ef90155da67b3835d6051f7866d213674df1/botocore-1.12.137.tar.gz";
        sha256 = "3213cf48cf2ceee10fc3b93221f2cd1c38521cca7584f547d5c086213cc60f35";
      };
      doCheck = commonDoCheck;
      checkInputs = commonBuildInputs ++ [ ];
      buildInputs = commonBuildInputs ++ [ ];
